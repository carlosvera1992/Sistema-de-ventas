  ...
  <body>
    ...
    <div class="container-fluid">
            ...
            <div class="collapse navbar-collapse" id="navbarSupportedContent">
              <ul class="navbar-nav mr-auto">
                <li class="nav-item active">
                  <a class="btn btn-outline-light" style="margin-left: 10px; border: none;" href="#">Home </a>
                </li>
                <li class="nav-item">
                  <a class="btn btn-outline-light" style="margin-left: 10px; border: none;" href="#">Cerdo</a>
                </li>
                <li class="nav-item">
                  <a class="btn btn-outline-light" style="margin-left: 10px; border: none;" href="#">Empleado</a>
                </li>
                <li class="nav-item">
                  <a class="btn btn-outline-light" style="margin-left: 10px; border: none;" href="#">Cliente</a>
                </li>
                <li class="nav-item">
                  <a class="btn btn-outline-light" style="margin-left: 10px; border: none;" href="#" >Venta</a>
                </li>
                <li class="nav-item dropdown">
                  <a class="btn btn-outline-light dropdown-toggle" style="margin-left: 10px; border: none;" href="#" id="navbarDropdown" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                    Mantenimiento
                  </a>
      ...
      <div class="row" style="background-color: #F0FFFF;">
        <div class="col-xs-12 col-sm-12 col-md-7 col-lg-7 col-xl-7 m-2">
          <iframe style="height:100%; width: 100%; " ></iframe>
        </div>

        <div class="col-xs-12 col-sm-12 col-md-4 col-lg-4 col-xl-4 m-2">
            <div class="p-2">
          ...
          <div class="card m-4" style="width:400px">
            <img class="card-img-top" src="../img/carlos.png " alt="Card image" style="width:100%; height:250px;">
            <div class="card-body " style="background-color: #7FFFD4;">
              <h4 class="card-title">Carlos Vera</h4>
              <p class="card-text font-weight-bold">Soy estudiante de desarrollo de software en la Uniremington</p>
